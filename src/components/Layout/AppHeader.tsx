        ...
        <nav className='flex items-center gap-2'>
          <div className='relative' ref={dropdownRef}>
            <button
              ...
              className='flex items-center gap-2 rounded-full border border-[#E5E2DA] pl-1 pr-3 py-1 text-sm font-medium text-[#6B6560] transition-colors hover:border-[#D0CBBF] hover:text-stone-900 bg-white'
            >
            ...
            {/* Dropdown Menu */}
            {isDropdownOpen && (
              <div className='absolute right-0 mt-2 w-48 rounded-xl bg-white border border-[#E5E2DA] shadow-[0_4px_16px_rgba(28,25,23,0.09)] overflow-hidden'>
                <div className='py-1'>
                  <Link
                    to='/'
